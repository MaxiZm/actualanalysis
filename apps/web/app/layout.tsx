...
export const metadata: Metadata = {
  metadataBase: new URL("https://actualanalysis.org"),
  title: {
  ...
  openGraph: {
    ...
    description: "Open model rankings with uncertainty, benchmark provenance, and reproducible Mixed, Agentic, and Chat indexes.",
  },
  twitter: {
    card: "summary_large_image",
    title: "ActualAnalysis — open model capability indexes",
    description: "Open model rankings with uncertainty, benchmark provenance, and reproducible capability indexes.",
  },
};
...
export default async function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return (
    <html lang="en" suppressHydrationWarning data-scroll-behavior="smooth">
      <body>
        <Script id="theme-bootstrap" strategy="beforeInteractive">{themeScript}</Script>
        <a className="skip-link" href="#main-content">Skip to content</a>
        <div className="app-shell">
          <SiteHeader models={data.models} benchmarks={data.benchmarks} status={data.status} />
          {data.status.mode === "fixture" ? <aside className="fixture-banner"><strong>Fixture data.</strong> {data.status.disclaimer}</aside> : null}
